...
// =========================================
//
// Сейчас Admin сам добавляет и удаляет книги.
//
// Теперь сделай так, чтобы Admin мог
// выдавать книги пользователям.
//
// =========================================
//
// Добавь в класс Admin метод:
//
...
// 2. Попросить библиотеку выдать книгу пользователю.
//
// =========================================
//
// ВАЖНО
//
// ❌ Нельзя внутри метода писать:
//
// user.takeBook(book);
//
// ❌ Нельзя писать:
...
//
// Админ не знает,
// как библиотека выдает книги.
//
// Он знает только,
// что у библиотеки есть нужный метод.
//
// =========================================
//
// Проверка:
...
// =========================================
//
// После выполнения подумай:
//
// Какой ОДИН метод библиотеки
// должен вызвать Admin?
//
// Именно его и нужно использовать.
//
